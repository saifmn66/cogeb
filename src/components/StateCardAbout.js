...
export default function StateCardAbout() {
  return (
    <div>
      <div className="text-white  font-[sans-serif]">
        <div className=" max-w-[70vw] mx-auto px-4">
          <div className="grid grid-cols-1 bg-[#3A5A40] rounded-lg md:grid-cols-2 lg:grid-cols-3 sm:gap-8 gap-4 max-md:max-w-md mx-auto">
