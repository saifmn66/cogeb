...
export default function Card1About() {
  return (
    <div>
      <div className="grid place-items-center max-h-full max-w-[100vw] pt-60 sm:pt-40 mx-auto sm:p-32 p-6 font-[sans-serif]">
        <div className="grid md:grid-cols-2 items-center gap-4 justify-between">
          ...
          <div className="md:col-span-1 mt-24">
            <div className="mb-12 sm:max-w-[50vw] sm:ml-8 md:ml-20"> 
              <h2 className="text-white sm:-ml-72 -z-10 w-fit text-3xl mb-10 px-10 py-6 bg-[#3A5A40] rounded-lg font-extrabold">
                A PROPOS DE NOUS
              </h2>
              <p> 
